...
using MachineFailureModel_ConsoleApp;

// Create single instance of sample data from first line of dataset for model input
MachineFailureModel.ModelInput sampleData = new MachineFailureModel.ModelInput()
{
    Product_ID = @"L47181",
    Type = @"L",
...
var sortedScoresWithLabel = MachineFailureModel.PredictAllLabels(sampleData);
